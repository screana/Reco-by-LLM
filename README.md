...
めっちゃ私用。でも全然使える内容だと思うのでLocalLLM興味あれば見てみてもいいかもです？  
あと、このReadmeもかなり砕けた書き方をしているので参考にはならないかもしれないです。申し訳ない

# 個人的な目標
研究で1年ぶりにLLMの研究をやるから、個人的に作ってみたかったシステムの実装をやってみる。  
あとSQLを使った読み書きも久しぶりに手書きでやりたいよね。

本チャン（VLMをつかったHigh-context imageの解析）の研究で役立ちそうなことをいろいろやっておきたい
1. なんとなく研究してた内容を思い出す
2. 新しいPCになったので環境構築もする
3. Ollamaって結局使ってなかったから使ってみる
4. 個人開発だからCodexバリバリ使ってみる
